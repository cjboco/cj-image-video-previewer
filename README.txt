...
------------------------------------------------------------------------------------------
images          This should be an array object of image sources.                   []
				(example ['images/myimage1.jpg','images/myimage2.jpg'])

autoPlay        Determines if the preview starts automatically.                    false
                If you set this to false, then you will need to
                start the frameshow by calling $("#MyframeShow").start();
